...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_STARLY] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_KEEN_EYE, ABILITY_RECKLESS },
    #else
        .abilities = { ABILITY_BIG_PECKS, ABILITY_KEEN_EYE, ABILITY_RECKLESS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_KEEN_EYE, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
