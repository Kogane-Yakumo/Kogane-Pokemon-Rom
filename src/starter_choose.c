...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_CETODDLE)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_VULPIX)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_MUDBRAY)
